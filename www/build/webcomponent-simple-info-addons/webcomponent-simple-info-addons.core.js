...
((w,d,x,n,h,c,r)=>{((s)=>{s&&(r=s.getAttribute('data-resources-url'))})(d.querySelector("script[data-namespace='webcomponent-simple-info-addons']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"WebcomponentSimpleInfoAddons","hydrated",[["simple-paragraph","simple-paragraph",1,[["header",1,0,1,2],["message",1,0,1,2],["mode",1,0,1,2],["width",1,0,1,2]]]]);